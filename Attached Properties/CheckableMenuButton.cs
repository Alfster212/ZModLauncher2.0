...
internal class CheckableMenuButton : RadioButton
{
    ...
    public static readonly DependencyProperty ImageIconProperty =
        DependencyProperty.Register("ImageIcon", typeof(ImageBrush), typeof(CheckableMenuButton));
    ...
    public ImageBrush ImageIcon
    {
        get => (ImageBrush)GetValue(ImageIconProperty);
